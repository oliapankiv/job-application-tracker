...
export class ApplicationDetail implements OnInit {
  readonly applicationsRoute = ApplicationRoute.Main;
  ...
  load(): void {
    ...
    this.applicationService.getApplication(this.applicationId).subscribe({
      ...
      error: () => {
        this.loading.set(false);
        this.router.navigate([ApplicationRoute.Main]);
      }
    });
  }
  ...
  deleteApplication(): void {
    ...
    ref.afterClosed().subscribe((confirmed) => {
      if (confirmed) {
        this.applicationService.deleteApplication(app.id).subscribe(() => this.router.navigate([ApplicationRoute.Main]));
      }
    });
  }
